...
namespace ERP.AuthService.Api.Controllers
{
    ...
    public class ControlesController : ControllerBase
    {
        ...
        {
            List<ControleResponseDto> result = await _controleService.GetAllAsync();
            return Ok(result);
        }
        ...
        {
            PagedResultDto<ControleResponseDto> result = await _controleService.GetAllPagedAsync(pageNumber, pageSize);
            return Ok(result);
        }
        ...
        {
            ControleResponseDto? controle = await _controleService.GetByIdAsync(id);
        ...
        {
            PagedResultDto<ControleResponseDto>? result = await _controleService.GetByCategoryAsync(category, pageNumber, pageSize);
        ...
        public async Task<IActionResult> Create([FromBody] ControleRequestDto dto)
        {
            ...
            ControleResponseDto created = await _controleService.CreateControleAsync(dto, requesterId);
        ...
        public async Task<IActionResult> Update(Guid id, [FromBody] ControleRequestDto dto)
        {
            ...
            ControleResponseDto? result = await _controleService.UpdateControleAsync(id, dto, requesterId);
            return result is null ? NotFound() : Ok(result);
        }
