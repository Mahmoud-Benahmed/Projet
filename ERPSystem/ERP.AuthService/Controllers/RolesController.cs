...
namespace ERP.AuthService.Api.Controllers
{
    ...
    public class RolesController : ControllerBase
    {
        ...
        {
            RoleResponseDto? role = await _roleService.GetByIdAsync(id);
        ...
        public async Task<IActionResult> Create([FromBody] RoleCreateDto dto)
        {
            ...
            RoleResponseDto created = await _roleService.CreateRole(dto, requesterId);
        ...
        public async Task<IActionResult> Update(Guid id, [FromBody] RoleUpdateDto dto)
        {
            ...
            RoleResponseDto? result = await _roleService.UpdateAsync(id, dto, requesterId);
